...
export { AddressMode, BlendFactor, BlendOperation, BufferBindingType, BufferUsage, CanvasCompositingAlphaMode, ColorWrite, CompareFunction, CompilationMessageType, ComputePassTimestampLocation, CullMode, DeviceLostReason, ErrorFilter, FeatureName, FilterMode, FrontFace, IndexFormat, InputStepMode, LoadOp, MapMode, PowerPreference, PrimitiveTopology, QueryType, RenderPassTimestampLocation, SamplerBindingType, ShaderStage, StencilOperation, StorageTextureAccess, StoreOp, TextureAspect, TextureDimension, TextureFormat, TextureSampleType, TextureUsage, TextureViewDimension, VertexFormat };
