...
var rebaseRelativePath: any = memoize(
  function (sourceFile, relativeRoot, relativePath) {
    if (!relativePath) {
      return relativePath
    }
    ...
    if (
      sourceFile === relativeRootedPath || // same path,
...
const create = function (file?, sourceRoot?) {
...
export const mapFileCommentRegex = new RegExp(
...
export { fromComment, create, removeComments, dedent, convert, offsetSourceMaps, merge }
